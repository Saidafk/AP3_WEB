...
<div class="d-flex flex-column justify-content-center align-items-center main-content">
        <div class="col-12 col-md-9 d-flex">
            <div class="px-5">
                ...
                <h2 class="mt-5">À propos de Hackat’Innov 👋</h2>
                
</p>Bienvenue sur la plateforme Hackat’Innov ! Nous sommes une start-up innovante dédiée à simplifier la gestion des hackathons. Depuis notre création, nous avons travaillé pour offrir des outils modernes permettant aux participants, organisateurs et partenaires de collaborer efficacement.
                </p>
